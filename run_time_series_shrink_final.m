function run_result=run_time_series_shrink_final(p,dt,antigen_satu,tau_up,func_num,n_list,K_list,q_max_list,init_list,T_list_temp,K2)
...
for i=2:length(T)
    ...
    Ha_mTh=q_max*(A^n/(A^n+K^n));
    Ha_mTr=q_max*(A^n/(A^n+K^n));
