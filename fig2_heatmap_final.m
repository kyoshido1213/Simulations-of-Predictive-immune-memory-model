function fig2_heatmap_result=fig2_heatmap_final(p,dt,t_end,q,K_list,n_list,q_max_list,antigen_list_heatmap,func_num,tau_up,K2_list)
...
heatmap_result_Mr=zeros(length(K2_list),length(antigen_list_heatmap));
        ...
        for k=1:length(K2_list)
            ...
            K2=K2_list(k);
            conc_dep_heatmap=fig2_conc_dep_shrink_heatmap_final(p,dt,t_end,q,K_list,n_list,q_max_list,antigen_list_heatmap,func_num,tau_up,K2);
