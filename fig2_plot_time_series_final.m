function fig=fig2_plot_time_series_final(result_data,p,antigen_satu)
...
% % if antigen_satu==200
% %     savefig(f,['fig2_high_dose_time_series(',num2str(DateString),').fig'])
% %     saveas(f,['fig2_high_dose_time_series(',num2str(DateString),').eps'],'epsc2')%最後に"epsc2"を付けないとモノクロで出力されてしまう
% % elseif antigen_satu==20
% %     savefig(f,['fig2_low_dose_time_series(',num2str(DateString),').fig'])
% %     saveas(f,['fig2_low_dose_time_series(',num2str(DateString),').eps'],'epsc2')
% % else
