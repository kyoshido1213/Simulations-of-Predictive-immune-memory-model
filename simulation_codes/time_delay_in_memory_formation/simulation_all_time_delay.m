%%% Simulations of the predictive immune memory model with time delay in memory formation %%%
clear
                          ...
                          func_num=1;%linear dose response
                            ...
                            %% time series simulation under high or low antigen concentrations (fig2A and B)
                               ...
                               t_end=10000;
                                 ...
                                 %% high antigen concentration (related fig2A)
...
% %                                    
        ...
        % %                            sgtitle(['delay=',num2str(delayed_time)])
                                 ...
                                 %% low antigen concentration (related to fig2B)
