function shrink_result=shrink_pre_final(p,dt,t_end,antigen_satu,tau_up,q,K2,func_num)
...
%         disp(pros1)
        ...
        high_dose_result=run_time_series_shrink_final(p,dt,antigen_satu,tau_up,init_list,T_list_temp,K2,func_num);
