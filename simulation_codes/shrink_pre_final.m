function shrink_result=shrink_pre_final(p,dt,t_end,antigen_satu,tau_up,func_num,n_list,K_list,q_max_list,q,K2)
...
%         disp(pros1)
        ...
        high_dose_result=run_time_series_shrink_final(p,dt,antigen_satu,tau_up,func_num,n_list,K_list,q_max_list,init_list,T_list_temp,K2);
