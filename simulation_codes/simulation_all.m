...
%% Figure2
      ...
      func_num=1;%linear dose response
        ...
        %% time series simulation under high or low antigen concentrations (fig2A and B)
           ...
           t_end=10000;
             ...
             %% low antigen concentration (fig2B)
               ...
               low_dose_result=run_time_series_final(p,dt,t_end,antigen_satu,tau_up,func_num);

               %plot
               fig2_plot_time_series_final(low_dose_result,p,antigen_satu)
        ...
        %% dependency of steady state response on antigen concentration and a parameter K in predictive coding (fig2e)
            ...
            heatmap_result_1=fig2_heatmap_final(p,dt,t_end_1,q,antigen_list_heatmap_1,tau_up,K2_list_1,func_num);
            ...
            heatmap_result_2=fig2_heatmap_final(p,dt,t_end_2,q,antigen_list_heatmap_2,tau_up,K2_list_2,func_num);
            ...
            heatmap_result_3=fig2_heatmap_final(p,dt,t_end_3,q,antigen_list_heatmap_3,tau_up,K2_list_3,func_num);
           ...
           %% integration
            ...
            len_K=length(K2_list_1);

            fig2_heatmap_result_Th=[heatmap_result_1(1:len_K,:) heatmap_result_2(1:len_K,:) heatmap_result_3(1:len_K,:)];
            fig2_heatmap_result_Tr=[heatmap_result_1((len_K+1):2*len_K,:) heatmap_result_2((len_K+1):2*len_K,:) heatmap_result_3((len_K+1):2*len_K,:)];
            fig2_heatmap_result_R=[heatmap_result_1((2*len_K+1):3*len_K,:) heatmap_result_2((2*len_K+1):3*len_K,:) heatmap_result_3((2*len_K+1):3*len_K,:)];

            fig2_heatmap_result_Mh=[heatmap_result_1((3*len_K+1):4*len_K,:) heatmap_result_2((3*len_K+1):4*len_K,:) heatmap_result_3((3*len_K+1):4*len_K,:)];
            fig2_heatmap_result_Mr=[heatmap_result_1((4*len_K+1):5*len_K,:) heatmap_result_2((4*len_K+1):5*len_K,:) heatmap_result_3((4*len_K+1):5*len_K,:)];
...
%% Figure3 
        ...
        %% time series simulation under rapid or slow antigen rapidness (fig3A and B)   
           ...
           %% high antigen concentration with rapid increase
             ...
             tau_up_temp=100;
             rapid_dose_result=run_time_series_final(p,dt,t_end,antigen_satu,tau_up_temp,func_num);
           ...
           %% high antigen concentration with slow increase%%%  
             ...
             tau_up_temp=1000;
             slow_dose_result=run_time_series_final(p,dt,t_end,antigen_satu,tau_up_temp,func_num);
        ...
        %% input rapidness dependency (convergence value of intensity of response) (fig3c)
            ...
            q=10;
            tau_list=1:1:1500;
            tau_result_satu=fig3_dynamics_dep_shrink_final(p,dt,t_end,q,antigen_satu,tau_list,p.K2,func_num);
            ...
            [heatmap_result_Th_1,heatmap_result_Tr_1,heatmap_result_R_1,heatmap_result_Mh_1,heatmap_result_Mr_1]=fig3_heatmap_final(dt,q,antigen_satu_list_1,tau_list,t_end,p,func_num);
            ...
            [heatmap_result_Th_2,heatmap_result_Tr_2,heatmap_result_R_2,heatmap_result_Mh_2,heatmap_result_Mr_2]=fig3_heatmap_final(dt,q,antigen_satu_list_2,tau_list,t_end,p,func_num);
            ...
            [heatmap_result_Th_3,heatmap_result_Tr_3,heatmap_result_R_3,heatmap_result_Mh_3,heatmap_result_Mr_3]=fig3_heatmap_final(dt,q,antigen_satu_list_3,tau_list,t_end,p,func_num);
...
%% Figure4
        ...
        %% time series in allergen immunotherapy(fig4A)
          ...
          func_num_Th=1;%linear dose response
          func_num_Tr=1;%linear dose response
          ...
          t_end=p.ts_init1+p.duration1+...
            ...
            %% therapy by low dose administration
                ...
                antigen_st2=20;
                history_result_low=therapy_time_series_final(p,t_end,dt,antigen_st2,p.tau_up2,func_num_Th,func_num_Tr);
                %plot
            ...
            %% dependency of therapeutic effect on antigen concentration in therapy (fig4B)
               ...
               therapy_effect_list=fig4_therapy_dose_dep_heatmap(p,dt,t_end,antigen_st2_list,p.tau_up2,func_num_Th,func_num_Tr);
          ...
          %% dependency of therapeutic effect on antigen concentration and input rapiddness in therapy (fig4C)
            ...
            for i=1:length(tau_list)
                ...
                therapy_effect_list=fig4_therapy_dose_dep_heatmap(p,dt,t_end,antigen_st2_list,tau_up2_temp,func_num_Th,func_num_Tr);
...
%% Figure5
        p=get_para_final_fig5;
        %%These parameters are different from "get_para_final.m" only in terms of parameters of antigen input%%
      ...
      %% steady state response (convergence value of memory T cell and intensity) (Fig5B,E,H)
           ...
           %% sigmoid dose-response (Fig5E)
               %antigen=0~7:t_end=1000000*10*10*10,antigen=8~13:t_end=1000000*10,antigen=14~500:t_end=1000000
               tic
               func_num=2;%%Th and Tr have same dose-response type
               
               %% antigen=0~7 (t_end=1000000*10*10*10 for convergence)
               Antigen_list_1=0:1:7;
               t_end=1000000*10*10*10;
               antigen_dependency_result_1=run_conc_dep_shrink_final(p,dt,t_end,q,Antigen_list_1,tau_up,p.K2,func_num);
               
              
               %% antigen=8~13 (t_end=1000000*10 for convergence)
               Antigen_list_2=8:1:13;
               t_end=1000000*10;
               antigen_dependency_result_2=run_conc_dep_shrink_final(p,dt,t_end,q,Antigen_list_2,tau_up,p.K2,func_num);
               
    
               %% antigen=14~500 (t_end=1000000 for convergence)
               Antigen_list_3=14:1:500;
               t_end=1000000;
               antigen_dependency_result_3=run_conc_dep_shrink_final(p,dt,t_end,q,Antigen_list_3,tau_up,p.K2,func_num);
       ...
       %% time-series of immunotherapy in each dose-response (Fig5C,F,I)
              ...
              T_total=0:dt:(t_end_former+t_end_latter);
                ...
                %linear function
                func_num_Th=1;func_num_Tr=1;
                [history_result_linear_former,history_result_linear_latter]=therapy_time_series_former_latter_final(t_end,dt,p,func_num_Th,func_num_Tr,T_former,T_total);

                %sigmoid function
                func_num_Th=2;func_num_Tr=2;
                [history_result_sig_former,history_result_sig_latter]=therapy_time_series_former_latter_final(t_end,dt,p,func_num_Th,func_num_Tr,T_former,T_total);

                %step function
                func_num_Th=3;func_num_Tr=3;
                [history_result_step_former,history_result_step_latter]=therapy_time_series_former_latter_final(t_end,dt,p,func_num_Th,func_num_Tr,T_former,T_total);
...
%% FigureS1
      ...
      func_num_Tr=1;
          ...
          %plot
            S_fig1_plot_dose_response_each_fig_final(history_result_linear_former,history_result_linear_latter,...
                                                     history_result_sig_former,history_result_sig_latter,...
                                                     history_result_step_former,history_result_step_latter,func_num_Tr)
...
%% FigureS2
    ...
    persistency_matrix=zeros(3,3);
        ...
        for i=1:3
                    ...
                    %%%dose response type of Tr cells
                    func_num_Tr=i;
                    ...
                    %linear
                    func_num=1;
                    [Rmax_1st_linear,Rmax_3rd_linear,Rmax_5th_linear]=S_fig2_therapy_effect_final(p,dt,t_end_former,t_end_latter,history_result_linear_former,history_result_linear_latter);

                    %sigmoid
                    func_num=2;
                    [Rmax_1st_sig,Rmax_3rd_sig,Rmax_5th_sig]=S_fig2_therapy_effect_final(p,dt,t_end_former,t_end_latter,history_result_sig_former,history_result_sig_latter);

                    %step
                    func_num=3;
                    [Rmax_1st_step,Rmax_3rd_step,Rmax_5th_step]=S_fig2_therapy_effect_final(p,dt,t_end_former,t_end_latter,history_result_step_former,history_result_step_latter);




                    %%the calculation of therapeutic effect
                    %linear
