function para=get_para_final_fig5
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
para.duration2=((3000/2*3+1200)*1.5-1200+3000)*2*(2/3)*(3/4);
para.input_num2=1; 
para.III2=50*0;
para.ts_init2=2000;
para.sig_num2=3;
...
%time constant in antigen input
para.tau_up1=1;
para.tau_down1=1;
para.tau_up2=1;
para.tau_down2=1;
