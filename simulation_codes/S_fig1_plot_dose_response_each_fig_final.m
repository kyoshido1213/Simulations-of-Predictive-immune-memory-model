function fig=S_fig1_plot_dose_response_each_fig_final(history_result_linear_former,history_result_linear_latter,...
...
%    ylim([0,max(max_list)])
  ...
  %    ylim([0,max(max_list)])
   ...
   elseif func_num_Tr==2
       sgtitle('Tr dose-response:sigmoid')
   elseif func_num_Tr==3
